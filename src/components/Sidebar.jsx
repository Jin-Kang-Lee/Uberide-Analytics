...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-white dark:bg-[#181A20] shadow-sm p-4 rounded-2xl flex flex-col h-full">
      {/* Logo / Header */}
      ...
      {/* Navigation */}
      <nav className="flex-1 p-4 space-y-6 overflow-y-auto text-gray-800 dark:text-gray-200">
          ...
          <div className="space-y-1">
            ...
            >
              {({ isActive }) => (
                <>
                  <FaBookOpen 
                    className={isActive ? "text-white dark:text-black" : "text-orange-500 dark:text-yellow-400"} 
                  />
