    ...
    <div className="flex h-screen bg-gray-50 dark:bg-[#0B0E11] text-gray-800 dark:text-gray-200">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-6 space-y-8 overflow-y-auto">
          {/* -------------------- KPI Cards -------------------- */}
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-yellow-400">📊 Key Metrics Overview</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              {loading ? (
                <p className="col-span-5 text-center text-gray-500 dark:text-gray-400">Loading dashboard...</p>
              ) : error ? (
                ...
                <p className="col-span-5 text-center text-gray-500 dark:text-gray-400">No data available</p>
              )}
            </div>
          </section>
          ...
          {/* -------------------- Charts -------------------- */}
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-yellow-400">📈 Operational Insights</h2>
          ...
          {/* -------------------- Trends -------------------- */}
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-yellow-400">📆 Booking Trend</h2>
            <Chart title="Rides Over Time" endpoint="rides-trend" />
          </section>

          {/* -------------------- Table -------------------- */}
          {/* <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-yellow-400">🧾 Recent Bookings</h2>
            <DataTable />
          </section> */}
        </main>
      </div>
